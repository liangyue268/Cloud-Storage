...
body h1{text-align:center;} 
  ...
  <tr>
    ...
    <a  href="/jspDev/servlet/download_Servlet?name=<%=a[i] %>&req=0" target="frm" class="style2 " onclick="return checkForm(<%=i %>)"><font color=red>Download</font> </a>
    <a>&nbsp;</a>
    <img src="img/star.jpg" width="20" hright="20">
    <a href="/jspDev/rating.jsp?fnam=<%=a[i] %>" target="frm" class="style2 "><font color=red>Rate</font> </a><br>
    </tr>
